...
class _TenantLoginState extends State<TenantLogin> {
  final _tenantloginformKey = GlobalKey<FormState>();
            ...
            children: [
              ...
              Padding(
                ...
                child: AllRoundButton(
                  ...
                  placeholder: 'Login',
                  onTap: () {
                    if (_tenantloginformKey.currentState.validate()) {
                      model.signin(
                          phoneNumber: phoneNumberController.text,
                          password: passwordController.text);
                    }
                    // locator<NavigationService>().navigateTo(TenantLandingView);
                  },
              ...
              Center(
                child: ClickText(
                  ...
                  onTap: () =>
                      nav.navigateTo(EmailFieldForPasswordResetViewTenant),
                ),
              ),
              Center(
                child: Padding(
