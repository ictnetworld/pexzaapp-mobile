...
class UpdateLandLordProfile extends StatefulWidget {
  @override
  _UpdateLandLordProfileState createState() => _UpdateLandLordProfileState();
}

class _UpdateLandLordProfileState extends State<UpdateLandLordProfile> {
  var prefs = locator<PrefsManager>();
  final _updateLandLordFormKey = GlobalKey<FormState>();
              ...
              Padding(
                ...
                child: AllRoundButton(
                  ...
                  onTap: () async {
                    ...
                    Landlordperson landlord =
                        Landlordperson.fromJson(jsonDecode(det)["data"]);
                        print(jsonDecode(det)["data"]["phone"]);
                    if (model.pickedImage == null) {
                      print("Ze phone ${landlord.phone}");
                      await model.updateProfileLand(
